...
const playerCollisionOffset2 = 330;
const ballDiam = 20;
...
const containerHeight_variation = containerHeight - 15;
...
function checkPlayerScore()
{
    ...
    if (player1Score >= 3 || player2Score >= 3) 
    {
        if (player1Score >= 3)
        {
            player1_score.textContent = 'Winner';
            player2_score.textContent = 'Loser';
        } 
        else
        {
            player2_score.textContent = 'Winner';
            player1_score.textContent = 'Loser';
        }
